...
public class ClaimState implements LinearState {
...
//    private String treatmentReceiptNumber; // หมายเลขใบเสร็จค่ารักษา
    ...
    public ClaimState(double amount,
                      int count,
    ...
    public ClaimState acceptToCliam(boolean isAccept, Party issuer){
        ClaimState newClaim =  new ClaimState(this.amount,this.count,this.hospitalNumber,this.insuranceID, this.insurance,this.hospital,isAccept,issuer,this.linearId);
        return newClaim;
    }
