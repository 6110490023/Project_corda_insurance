...
angular.module('demoAppModule', ['ui.bootstrap']).controller('DemoAppCtrl', function ($http, $location, $uibModal) {
    ...
    demoApp.openCreateClaimModal = () => {
        const createClaimModal =  $uibModal.open({
            templateUrl: 'createClaim.html',
            controller: 'CreateClaimModalCtrl',
            controllerAs: 'createClaimModal',
            resolve: {
